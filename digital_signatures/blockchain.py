...
class Blockchain:
    ...
    def add_transactions(self, sender, receiver, file_hash):
...
def mine_block():
    ...
    hash = request.args.get('file_hash',None)
   #password = request.args.get('password')
    blockchain.add_transactions(sender=node_address, receiver="Miner",file_hash=hash)
